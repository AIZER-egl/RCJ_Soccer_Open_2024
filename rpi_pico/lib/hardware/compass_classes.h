 ...
 *  Modifications:
 *
 *  Added support for the raspberry pi pico C/C++ SDK
 *  WARNING: This library *DOES NOT* support the Adafruit Sensor API
 *
 *  Copyright (c) 2024
 *  Copyright (c) 2024 PREPATEC AIZER EGL
 *
 *  This software includes modifications by PREPATEC AIZER EGL.
 */
